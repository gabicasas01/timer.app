    ...
    <>
      {!settingState ? (
        <div className="flex flex-col items-center justify-center min-h-screen bg-[#1a345c] select-none">
          ...
          <button
            className="w-36 bg-gray-600  px-4 py-2 text-white font-medium rounded-full focus:outline-none absolute bottom-2 md:bottom-30 left-1/2 transform -translate-x-1/2"
